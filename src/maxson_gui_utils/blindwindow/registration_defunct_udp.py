...
def dispatch_write(
    ...
    *,
    ...
    if transport is IPCTransport.SPOOL_FILE:
        ...
        print("BlindWindow no longer supprts UDS, UDP, or Nmaed Pipe. You get a spool file, which is not networked and is recognized as safe.")
...
# this function is used elsewhere and must be adjusted for the sppol only approach?
